...
diabetes_model = pickle.load(open("C:/Users/Sahil/Desktop/New folder/Multiple-Disease-Prediction-System-using-Machine-Learning-main/Saved models/diabetes_model.sav","rb",))
heart_disease_model = pickle.load(open("C:/Users/Sahil/Desktop/New folder/Multiple-Disease-Prediction-System-using-Machine-Learning-main/Saved models/heart_disease_model.sav","rb",))
parkinsons_model = pickle.load(open("C:/Users/Sahil/Desktop/New folder/Multiple-Disease-Prediction-System-using-Machine-Learning-main/Saved models/parkinsons_model.sav","rb",))
cancer_model = pickle.load(open("C:/Users/Sahil/Desktop/New folder/Multiple-Disease-Prediction-System-using-Machine-Learning-main/Saved models/cancer_model.sav","rb",))
obesity_model = pickle.load(open("C:/Users/Sahil/Desktop/New folder/Multiple-Disease-Prediction-System-using-Machine-Learning-main/Saved models/obesity_model.sav","rb",))
pressure_model = pickle.load(open("C:/Users/Sahil/Desktop/New folder/Multiple-Disease-Prediction-System-using-Machine-Learning-main/Saved models/pressure_model.sav","rb",))
